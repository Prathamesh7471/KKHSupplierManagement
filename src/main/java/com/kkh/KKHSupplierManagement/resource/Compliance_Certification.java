...
public class Compliance_Certification {
	...
	public String toString() {
		return "Compliance_Certification [document_name=" + document_name + ", certification_number="
				+ certification_number + ", supplier_name=" + supplier_name + ", compliance_standard="
				+ compliance_standard + ", certification_date=" + certification_date + ", expiration_date="
				+ expiration_date + ", certifying_authority=" + certifying_authority + ", compliance_statement="
