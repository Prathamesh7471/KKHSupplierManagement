...
public class KKHSupplierDocument {
	...
	public KKHSupplierDocument(Long id, String fileName, String fileType, byte[] data, String pricing_and_Payment_Terms,
			String term_and_Termination, String govering_Law_and_Jurisdication, String signatures,
			String itemized_Charges, String payment_Instructions, String insurance_Coverage,
