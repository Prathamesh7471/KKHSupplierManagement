...
public class Supplier_Parts {
	...
	private  Long iteration_info;
	private Long isletest_Iteration;
	...
	public Long getIteration_info() {
		return iteration_info;
	}
	public void setIteration_info(Long iteration_info) {
		this.iteration_info = iteration_info;
	}
	public Long getIsletest_Iteration() {
		return isletest_Iteration;
	}
	public void setIsletest_Iteration(Long isletest_Iteration) {
		this.isletest_Iteration = isletest_Iteration;
	}

	
	public Supplier_Parts() {
		super();
		// TODO Auto-generated constructor stub
	}
	public Supplier_Parts(Long id, String supplier_catagory, String supplier_name, String material, String mpn_number,
			String weight, String dimension, String cost, Date lead_date, String quality_matrices,
			String compliance_information, Long masterId, Date createdDate, Date modifiedDate, Long iteration_info,
			Long isletest_Iteration) {
		super();
		this.id = id;
		this.supplier_catagory = supplier_catagory;
		this.supplier_name = supplier_name;
	...
	public String toString() {
		return "Supplier_PartObject [id=" + id + ", supplier_catagory=" + supplier_catagory + ", supplier_name="
				...
				+ iteration_info + ", isletest_Iteration=" + isletest_Iteration + "]";
	}
