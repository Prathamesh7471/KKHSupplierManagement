...
@Entity
public class Supplier_Purchase_Order {
	...
	public Supplier_Purchase_Order(Long purchase_order_number, String purchase_order_name,
			String purchase_order_description, String supplier_category, String supplier_name, String part_type,
			String quantity, String unit_price, String total_price, Date delivery_date, String payment_terms,
			String shipping_method, String terms_and_conditions, String approval_status, String purchase_order_status) {
		this.purchase_order_number = purchase_order_number;
		this.purchase_order_name = purchase_order_name;
		this.purchase_order_description = purchase_order_description;
		this.supplier_category = supplier_category;
	...
	public Supplier_Purchase_Order() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "Supplier_Purchase_Order [purchase_order_number=" + purchase_order_number + ", purchase_order_name="
