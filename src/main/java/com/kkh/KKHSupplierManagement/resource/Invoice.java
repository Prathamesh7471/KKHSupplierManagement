...
public class Invoice {
	...
	public String toString() {
		return "Invoice [document_name=" + document_name + ", invoice_number=" + invoice_number + ", supplier_name="
				+ supplier_name + ", invoice_date=" + invoice_date + ", due_date=" + due_date + ", itemized_charges="
				+ itemized_charges + ", amount_due=" + amount_due + ", payment_instructions=" + payment_instructions
				+ "]";
	}
