...
public class Certification_of_Insurance {
	...
	public String toString() {
		return "Certification_of_Insurance [document_name=" + document_name + ", policy_number=" + policy_number
				+ ", supplier_name=" + supplier_name + ", insured_party=" + insured_party + ", insurance_coverage="
				+ insurance_coverage + ", effective_date=" + effective_date + ", expiration_date=" + expiration_date
				+ ", insurance_company=" + insurance_company + ", authorized_signatures=" + authorized_signatures + "]";
	}
